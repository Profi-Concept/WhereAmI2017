...
namespace WhereAmI2022
{
	...
	public class WhereAmISettings : IWhereAmISettings
	{
		...
		public bool ViewFilename { get; set; } = true;

		public bool ViewFolders { get; set; } = true;

		public bool ViewProject { get; set; } = true;
		...
		private void LoadSettings()
		{
			...
			try
			{
				...
				if (writableSettingsStore.PropertyExists(Constants.SettingsCollectionPath, "ViewFilename"))
				{
					...
					if (bool.TryParse(writableSettingsStore.GetString(Constants.SettingsCollectionPath, "ViewFilename"), out b))
					{
						this.ViewFilename = b;
					}
				}
				...
				if (writableSettingsStore.PropertyExists(Constants.SettingsCollectionPath, "ViewFolders"))
				{
					...
					if (bool.TryParse(writableSettingsStore.GetString(Constants.SettingsCollectionPath, "ViewFolders"), out b))
					{
						this.ViewFolders = b;
					}
				}
				...
				if (writableSettingsStore.PropertyExists(Constants.SettingsCollectionPath, "ViewProject"))
				{
					...
					if (bool.TryParse(writableSettingsStore.GetString(Constants.SettingsCollectionPath, "ViewProject"), out b))
					{
						this.ViewProject = b;
					}
				}
